...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2020 a las 01:05:09
...
CREATE TABLE `report_options` (
  `report_op_id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `report` (
  `report_id` int(11) PRIMARY KEY NOT NULL AUTO_INCREMENT,
  ...
  `tx_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tx_update` date NOT NULL,
   FOREIGN KEY (report_op_id) REFERENCES report_options(report_op_id),
