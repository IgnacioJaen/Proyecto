...
public class UserSubcategoryApi {
    ...
    @RequestMapping(path="/userSubMatchPremium",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    public List<UserSubcategory> getUserSubMatchesPremium(@RequestParam Integer userId, HttpServletRequest request) {
        List<UserSubcategory> userSubcategories=userSubcategoryBl.getUserSubMatchesPremium(userId);
        return userSubcategories;
    }
